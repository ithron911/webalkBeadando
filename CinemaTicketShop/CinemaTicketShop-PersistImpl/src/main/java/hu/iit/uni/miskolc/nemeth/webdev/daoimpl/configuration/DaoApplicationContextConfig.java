package hu.iit.uni.miskolc.nemeth.webdev.daoimpl.configuration;
...
@ComponentScan("hu.iit.uni.miskolc.nemeth.webdev.daoimpl")
@PropertySource("classpath:datasource.properties")
public class DaoApplicationContextConfig {


	private static final String DB_DRIVER_PROPERTY = "db.driverClassName";
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		localContainerEntityManagerFactoryBean.setPersistenceUnitName("CinemaTicketShop");
